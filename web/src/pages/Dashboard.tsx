...
import EarthObservationPanel from '../panels/EarthObservationPanel'
...
export default function Dashboard() {
  ...
  const sendChat = async () => {
    ...
    try {
      ...
      setChat((c) => [...c, { role: 'bot', text: 'The analyst backend is offline. Start the API with `uvicorn api.main:app` to chat live.' }])
    } finally {
      setChatBusy(false)
    }
  }
    ...
    <div className="dash">
      ...
      <header className="dash-top">
        <Link to="/" className="brand">
          ...
          <span className="tag">space situation platform</span>
        </Link>
              ...
              <section className="analyst panel">
                ...
                <div className="analyst-input">
                  <input
                    ...
                    placeholder="Ask about conjunctions, space weather, transients, exoplanets…"
                    disabled={chatBusy}
                  />
